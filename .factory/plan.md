...
- [x] T16 (major) — Bounded Phase 1 agent and cartridge contract
  ...
  - deps: T14
  - pr: 40
- [x] T17 (standard) — Authored natural-language input and shell passthrough
  ...
  - deps: T15, T16
  - pr: 41
- [x] T18 (standard) — Shared-machine awareness and compacted beliefs
...
- [x] T26 (standard) — Diegetic onboarding without shell spoilers
  ...
  - deps: T16, T17, T23
  - pr: 49
- [R] T27 (standard) — Semantic accessibility, reduced motion, and visual baseline
