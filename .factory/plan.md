...
- [x] T35 (standard) — Event-driven escalation and reactive status
  ...
  - deps: T32
  - pr: 60
- [x] T36 (standard) — Sparse persona routing and compact-damaged beliefs
  ...
  - deps: T32, T35
  - pr: 61
- [x] T37 (standard) — Predecessor-aware model handoffs
  ...
  - deps: T36
  - pr: 62
- [x] T38 (standard) — Deterministic intent families and mutating fallback
  ...
  - pr: 63
- [x] T39 (standard) — One-shot isolated rare-event draws
  ...
  - deps: T32
  - pr: 64
- [x] T40 (standard) — Stage-aware presentation mechanics
...
- [x] T41 (standard) — Load-balancer files, ownership, and tests
  ...
  - deps: T31
  - pr: 56
- [x] T42 (standard) — Restrained Git history, blame, and shell history
...
- [x] T43 (standard) — Services, endpoints, processes, and logs
  ...
  - deps: T41
  - pr: 67
- [x] T44 (standard) — Environmental evidence and hidden shell depth
...
- [x] T45 (standard) — Thirty meaningful command forms and investigations
  ...
  - deps: T44
  - pr: 69
- [x] T46 (standard) — Four voices over shared incident beats
...
- [x] T51 (standard) — Permission complicity and waiver callbacks
  ...
  - deps: T34, T41, T46
  - pr: 75
- [x] T52 (standard) — Archetype compact summaries and divergence callbacks
...
- [x] T53 (standard) — Rare disturbances and consequence chains
  ...
  - deps: T39, T45, T46
  - pr: 77
- [x] T54 (standard) — Replayable field-recognized habits
...
- [x] T55 (major) — Integrate and prove four collectible endings
  ...
  - pr: 80
- [x] T56 (standard) — Phase 2 headless replay and coherence gate
...
- [x] T61 (standard) — Stabilize handoff replay CI timing
